...
export function LandingPage() {
  ...
  return (
    <div className="bg-gray-50/50 min-h-screen flex flex-col">
      ...
      {/* Features Section */}
      <section className="bg-slate-900 text-slate-100 py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <div className="inline-flex items-center gap-1 rounded-md bg-blue-500/20 px-3 py-1 text-xs font-semibold text-blue-300 uppercase tracking-wider">
              <Sparkles className="h-3.5 w-3.5 text-blue-400" />
              <span>Core Deliverables</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
              Powerful Tools For Active Campus Life
            </h2>
            <p className="text-base sm:text-lg text-slate-400">
              Our platform offers comprehensive features catering to both student applicants and organization moderators.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="group bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:bg-slate-800 hover:-translate-y-1 transition-all duration-300">
              <div className="h-12 w-12 rounded-xl bg-blue-500/20 text-blue-400 flex items-center justify-center mb-6 ring-1 ring-blue-500/30 group-hover:scale-110 transition-transform">
                <Users className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Explore Communities</h3>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Easily filter and browse through a diverse array of technical clubs, cultural bands, literary societies, and sports wings.
              </p>
              <span className="text-xs font-semibold text-blue-400 inline-flex items-center gap-1 group-hover:underline">
            ...
            {/* Card 2 */}
            <div className="group bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:bg-slate-800 hover:-translate-y-1 transition-all duration-300">
              <div className="h-12 w-12 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center mb-6 ring-1 ring-emerald-500/30 group-hover:scale-110 transition-transform">
                <Briefcase className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Job Listings & Roles</h3>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Apply directly to open roles like developer, manager, designer, or editorial writer. Track your applications from review to selection.
              </p>
            ...
            {/* Card 3 */}
            <div className="group bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:bg-slate-800 hover:-translate-y-1 transition-all duration-300">
              <div className="h-12 w-12 rounded-xl bg-orange-500/20 text-orange-400 flex items-center justify-center mb-6 ring-1 ring-orange-500/30 group-hover:scale-110 transition-transform">
                <Calendar className="h-6 w-6" />
              </div>
              <h3 className="text-xl font-bold text-white mb-3">Event Schedules</h3>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Register for hackathons, seminars, social drives, and matches. Access event details and track attendance from a unified calendar.
              </p>
              <span className="text-xs font-semibold text-orange-400 inline-flex items-center gap-1 group-hover:underline">
                Explore Events <ArrowRight className="h-3.5 w-3.5" />
              </span>
            </div>
          </div>

          {/* Embedded Image Highlight */}
          <div className="mt-16 bg-slate-800/30 border border-slate-800 rounded-3xl overflow-hidden p-6 sm:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-7 space-y-4">
                <h3 className="text-xl sm:text-2xl font-bold text-white">Collaborative Space & Tech Hubs</h3>
                <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
                  Our campus is equipped with highly collaborative spaces and computing laboratories. The digital lab provides access to computing terminals, hardware testing units, and study pods enabling student organizations to work and create together.
                </p>
              ...
              <div className="lg:col-span-5 rounded-2xl overflow-hidden shadow-lg border border-slate-700/50">
                <img
                  src={college2}
                  alt="High-tech computer lab with students coding"
                  className="w-full h-[220px] object-cover hover:scale-102 transition-transform duration-300"
                />
              </div>
            </div>
          </div>
